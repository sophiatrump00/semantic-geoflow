            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                <dt class="text-sm font-medium text-gray-500 truncate">{{ __('admin.ai_configurator.cache_title') }}</dt>
                                <dd class="text-lg font-medium text-gray-900">{{ __('admin.ai_configurator.cache_desc') }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                <div class="bg-gray-50 px-6 py-3">
                    <div class="text-sm">
                        <a href="{{ route('admin.semantic-cache.index') }}" class="font-medium text-yellow-600 hover:text-yellow-500">
                            {{ __('admin.ai_configurator.cache_action') }} <span aria-hidden="true">&rarr;</span>
                        </a>
                    </div>
                </div>
            </div>
